		...
		for idx,v in enumerate(val):
			  ...
			  if xc == 'A1':
					...
					#3d
						...
						if v:
							...
							if bagc2 == "BA":
								loc = bart_dict_address[ba_route2].split('$')
								nws.cell(row=i,column= 39).value = loc[0]
								nws.cell(row=i,column= 40).value = loc[1]
						...
						if v:
							...
							if bagc2 == "BA":
								loc = bart_dict_address[ba_route2].split('$')
								nws.cell(row=i,column= 41).value = loc[2]
							print "Address"
					if xc2 == 'A1':
			...
			#3d
				...
				if v:
					...
					if aagc1 == "BA":
						loc = bart_dict_address[ba_route1_a].split('$')
						nws.cell(row=i,column= 62).value = loc[0]
						nws.cell(row=i,column= 63).value = loc[1]	
				...
				if v:
					...
					if aagc1 == "BA":
						loc = bart_dict_address[ba_route1_a].split('$')
						nws.cell(row=i,column= 64).value = loc[2]
						print "Address1 after"
			try:
				if xc_a == 'A1':
